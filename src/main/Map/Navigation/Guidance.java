...
public class Guidance extends Path {
    ...
    public void setImages() {
        try {
            ...
            elevatorImg = createResizedCopy(ImageIO.read(new File("src/main/resources/icons/elevator.png")), imgRescaleSize, imgRescaleSize, true);
            foodImg = createResizedCopy(ImageIO.read(new File("src/main/resources/icons/food.png")), imgRescaleSize, imgRescaleSize, true);
            infoImg = createResizedCopy(ImageIO.read(new File("src/main/resources/icons/info.png")), imgRescaleSize, imgRescaleSize, true);
...
*/
    ...
    public boolean sendEmailGuidance(String address) {
        String subjectLine;
        String directionLine = "<H1><center> You have chosen to navigate to " + (pathNodes.get(pathNodes.size() - 1)).toString() + ".</center></H1>" + "<H4>";
        ...
        try {
            SendEmail e = new SendEmail(address, subjectLine, floorSteps, true, floorSteps.size());
            return true;
        } catch(Exception e) {
