...
import Directory.AdminDirectoryEditorController;
...
public class SceneSwitcher
{
    ...
    public static void switchToModifyDirectoryView(Stage primaryStage, Hospital h) throws IOException {
