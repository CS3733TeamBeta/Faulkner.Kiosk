...
public class PathFindingTest extends TestCase{
    ...
    public void testUID() {
        ...
        Assert.assertEquals(nodeA, nodeA);
        Assert.assertEquals(nodeB, nodeB);
        Assert.assertNotSame(nodeA, nodeB);
    }
    ...
    public void testIsValidPath() {
        ...
        Assert.assertTrue(manPathValid.isValidPath());
        Assert.assertFalse(manPathInvalid.isValidPath());
    }
    ...
    public void testNoValidPathException() {
        try {
            ...
            Assert.fail("Failed to notice no possible path");
        } catch (Exception e) {
            Assert.assertTrue(e instanceof PathFindingNoPathException);
        }
        try {
