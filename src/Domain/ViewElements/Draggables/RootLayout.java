package Domain.ViewElements.Draggables;

import java.io.IOException;

import Domain.ViewElements.Draggables.DragIcon;
...
public class RootLayout extends AnchorPane{
	...
	{
		//imgView.fitHeightProperty().bind(right_pane.fty());

		//imgView.fitWidthProperty().bind(right_pane.widthProperty());
